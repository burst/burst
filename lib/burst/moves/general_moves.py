...
def getGreatKickLeft(cntr_param):
    return map(makeback, ( array(map(makesym,GREAT_KICK_LEFT_EXTD))*(1-cntr_param)  +   array(map(makesym,GREAT_KICK_LEFT))*cntr_param    ).tolist()) 

def getGreatKickRight(cntr_param):
    return mirrorMove(getGreatKickLeft(cntr_param))
