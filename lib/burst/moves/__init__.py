...
NAOJOINTS_EXECUTE_MOVE_MOVES = "STRAIGHT_WALK_INITIAL_POSE INITIAL_POS SIT_POS ZERO_POS STAND STAND_UP_FRONT STAND_UP_BACK GREAT_KICK_LEFT GREAT_KICK_RIGHT".split()
