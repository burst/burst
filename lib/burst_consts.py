...
SECONDARY_ATTACK_ON_LEFT, SECONDARY_ATTACK_INITIAL_Y = random.choice(((True, SECONDARY_ATTACK_LEFT_INITIAL_Y), (False, SECONDARY_ATTACK_RIGHT_INITIAL_Y)))
...
################################################################################
# Challenges related constants
################################################################################

# Set to true when running in the anyball challenge
anyball = False
...
################################################################################
################################################################################
# atan(6.0/1.3) - atan(6.0/2.7) - bearing distance
MINIMAL_GOAL_POST_BEARING_DIFFERENCE = 0.2
