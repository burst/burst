...
#ifdef VISIONMODULE_IS_REMOTE_OFF
...
{      
  ...
  ALModule::createModule<vision>( pBroker ,  "vision" );
...
{
  std::cout << "Exiting VISIONMODULE." << std::endl;
...
int main( int argc, char *argv[] )
{
 ...
 try
 {
   ...
   ALModule::createModule<vision>( broker ,  "vision" );
 }
 catch(ALError &e)
 {
   std::cout << "-----------------------------------------------------" << std::endl;
