...
# Move Head
motionProxy.post.gotoAngle('HeadRoll', -0.2, 0.4,motion.INTERPOLATION_SMOOTH)
"""
# Move Arms
Id3 = motionProxy.post.gotoAngle('LShoulderPitch', 0 * motion.TO_RAD, 0.4,motion.INTERPOLATION_SMOOTH)
Id3 = motionProxy.post.gotoAngle('RShoulderPitch', 0 * motion.TO_RAD, 0.4,motion.INTERPOLATION_SMOOTH)
Id3 = motionProxy.post.gotoAngle('LShoulderPitch', -20 * motion.TO_RAD, 0.4,motion.INTERPOLATION_SMOOTH)
Id3 = motionProxy.post.gotoAngle('RShoulderPitch', -20 * motion.TO_RAD, 0.4,motion.INTERPOLATION_SMOOTH)
Id4 = motionProxy.post.gotoAngle('LElbowRoll', -20 * motion.TO_RAD, InterpolationTimeForThisSection,motion.INTERPOLATION_SMOOTH)
Id4 = motionProxy.post.gotoAngle('RElbowRoll', 20 * motion.TO_RAD, InterpolationTimeForThisSection,motion.INTERPOLATION_SMOOTH)
Id4 = motionProxy.post.gotoAngle('LElbowRoll', 0 * motion.TO_RAD, InterpolationTimeForThisSection,motion.INTERPOLATION_SMOOTH)
Id4 = motionProxy.post.gotoAngle('RElbowRoll', 0 * motion.TO_RAD, InterpolationTimeForThisSection,motion.INTERPOLATION_SMOOTH)
Id3 = motionProxy.post.gotoAngle('LShoulderPitch', 0 * motion.TO_RAD, 0.4,motion.INTERPOLATION_SMOOTH)
Id3 = motionProxy.post.gotoAngle('RShoulderPitch', 0 * motion.TO_RAD, 0.4,motion.INTERPOLATION_SMOOTH)

#Id3 = motionProxy.post.gotoAngle('LShoulderPitch', 70 * motion.TO_RAD, 0.4,motion.INTERPOLATION_SMOOTH)
#Id3 = motionProxy.post.gotoAngle('LShoulderPitch', 120 * motion.TO_RAD, 0.4,motion.INTERPOLATION_SMOOTH)
